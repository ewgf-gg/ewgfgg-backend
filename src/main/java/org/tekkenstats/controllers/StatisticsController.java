...
import org.tekkenstats.configuration.StatisticsEventPublisher;
...
import org.tekkenstats.services.CharacterAnalyticsService;
...
public class StatisticsController {
    ...
    public ResponseEntity<String> calculateStatistics(HttpServletRequest request) throws InterruptedException {
        log.info("Received request to calculating statistics from {}", request.getRequestURI());
        try {
